...
~
\begin{minipage}{0.5\textwidth}
\includegraphics[height=70mm,width=100mm,trim=65 30 65 30,clip]{p3.jpg}
...
~
\begin{minipage}{0.5\textwidth}
\includegraphics[height=70mm,width=100mm,trim=65 30 65 30,clip]{p1.jpg}
...
\rule{\textwidth}{1pt}
\texttt{ENEMY2\_BALL\_TAKE\_GOAL} $_{\text{(\texttt{ENEMY1\_BALL\_TAKE\_GOAL})}}$
...
~
\begin{minipage}{0.5\textwidth}
\includegraphics[height=70mm,width=100mm,trim=65 30 65 30,clip]{p2.jpg}
\end{minipage}

\rule{\textwidth}{1pt}
\texttt{FREE\_BALL\_NONE\_GOALSIDE} $_{\text{(\texttt{FREE\_BALL\_1\_GOALSIDE}, \texttt{FREE\_BALL\_2\_GOALSIDE})}}$
...
~
\begin{minipage}{0.5\textwidth}
\includegraphics[height=70mm,width=100mm,trim=65 30 65 30,clip]{p4.jpg}
...
\rule{\textwidth}{1pt}\newline
\texttt{FREE\_BALL\_BOTH\_GOALSIDE} $_{\text{(\texttt{FREE\_BALL\_1\_GOALSIDE}, \texttt{FREE\_BALL\_2\_GOALSIDE})}}$
...
~
\begin{minipage}{0.5\textwidth}
\includegraphics[height=70mm,width=100mm,trim=65 30 65 30,clip]{p5.jpg}
